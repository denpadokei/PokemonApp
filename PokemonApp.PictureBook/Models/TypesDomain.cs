...
{
    public class TypesDomain : BindableBase
    {
        ...
        public IReadOnlyList<TypeEntity> TypeList
        {
            ...
            set => this.SetProperty(ref this.typeList_, value);
        }
        ...
        {
            var list = new List<TypeEntity>(this.TypeList);
            this.Collection.Clear();
        ...
        public bool Regist()
        {
            ...
            //        table.InsertOnSubmit(new type()
            //        {
            //            type_id = i,
            //            type_name = charact.Name
            //        });
            //        ++i;
